...
import 'package:rspsa_user/screens/teacher_portal/controller/teacher_home_controller.dart';
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          teacherHomeController.name.value,
                          style: TextStyle(
                              fontSize: 18.sp,
                              color: Colors.white,
                        ...
                        Text(
                          "Emial: ${teacherHomeController.userEmail.value}",
                          style: TextStyle(
                              fontSize: 16.sp,
                              color: Colors.white,
                        ...
                        Text(
                          "Mobile: ${teacherHomeController.userMobile.value}",
                          style: TextStyle(
                              fontSize: 16.sp,
                              color: Colors.white,
                              fontWeight: FontWeight.w500),
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: CircleAvatar(
                              child:
                                  teacherHomeController.prfilePicture.value !=
                                          ''
                                      ? ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(100.r),
                                          child: Image.network(
                                            '${teacherHomeController.userFilePath.value}/${teacherHomeController.prfilePicture.value}',
                                            width: 40.w,
                                            height: 30.h,
                                            fit: BoxFit.cover,
                                          ),
